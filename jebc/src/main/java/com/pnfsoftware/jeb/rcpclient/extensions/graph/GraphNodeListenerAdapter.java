...
public class GraphNodeListenerAdapter implements GraphNodeListener {
    private static final ILogger logger = GlobalLog.getLogger(GraphNodeListenerAdapter.class);
